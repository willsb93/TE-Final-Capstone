      ...
      <section class="section"><div class="container has-text-centered">
          ...
          <div class="columns">
            <div class="column is-4">
              ...
              <h5 class="title is-5"><a href="mailto:mark.maire@Standrew.com"><span class="dev-name">Mark Maire</span></a></h5>
              <p class="subtitle is-6">Software Developer | Vue Whisperer</p>
            ...
            <div class="column is-4">
              ...
              <h5 class="title is-5"><a href="mailto:william.rabuske@Standrew.com"><span class="dev-name">William Rabuske</span></a></h5>
            ...
            <div class="column is-4">
              <div class="level">
                <div class="level-item">
                  <figure class="image is-128x128"><img class="is-rounded" src="https://media-exp1.licdn.com/dms/image/C5103AQHVca0dwTBi4g/profile-displayphoto-shrink_200_200/0?e=1591833600&v=beta&t=LeIGYAIUnfvPUILKse7YwQJyD7Hmp9NfWepDW2J3f_8" alt=""></figure></div>
              </div>
              <h5 class="title is-5"><a href="mailto:ryan.brooks@Standrew.com"><span class="dev-name">Ryan Brooks</span></a></h5>
              <p class="subtitle is-6">Software Developer | DB Adminimizer </p>
              <p>Have good trust in yourself … not in the One that you think you should be, but in the One that you are.</p>
            </div>
          </div>
        </div>
      </section>
